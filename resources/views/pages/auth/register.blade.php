            ...
            <div class="max-w-md text-center text-white">
                <div class="mb-6">
                    <svg class="w-48 h-48 mx-auto" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M200 100C200 82.4315 214.431 68 232 68C249.569 68 264 82.4315 264 100V200H364C381.569 200 396 214.431 396 232C396 249.569 381.569 264 364 264H264V364C264 381.569 249.569 396 232 396C214.431 396 200 381.569 200 364V264H100C82.4315 264 68 249.569 68 232C68 214.431 82.4315 200 100 200H200V100Z" fill="white"/>
