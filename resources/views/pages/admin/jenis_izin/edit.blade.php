                ...
                <form action="{{ route('admin.jenis_izin.update', $jenisIzin) }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select id="kategori" name="kategori" required
                            ...
                            <option value="Penelitian" {{ old('kategori', $jenisIzin->kategori) == 'Penelitian' ? 'selected' : '' }}>Penelitian</option>
                            <option value="Praktik Nakes" {{ old('kategori', $jenisIzin->kategori) == 'Praktik Nakes' ? 'selected' : '' }}>Praktik Nakes</option>
                        </select>
                    </div>
